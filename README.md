## 자유게시판 게시글 관련 사항
C:\에 file_upload_test 디렉토리가 존재해야 정상적으로 게시글에 포함되어 있는 사진을 볼 수 있습니다.
(파일만 위치시키면 작동하지 않습니다. 꼭 디렉토리 전체를 위치시켜야 합니다.)
main 브랜치 최상위 디렉토리에,
[file_upload_test] 디렉토리를 다운로드 받아 위치시키면 정상적으로 보입니다.
